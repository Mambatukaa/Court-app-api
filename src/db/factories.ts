...
export const userFactory = async (params: IUser) => {
...
export const courtFactory = async (params: ICourt) => {
...
export const bookingFactory = async (params: IBooking) => {
...
export const scheduleFactory = async (params: ISchedule) => {
...
export const factoriesFactory = async () => {
  ...
  //   image:
  //     'https://cugoldeneagles.com/images/2019/7/11/CU_Facilities_Digital_11.jpg'
  // });
  ...
  //   image:
  //     'https://www.ryerson.ca/content/dam/recreation/Facilities/CCC_737wv2.jpg'
  // });
  ...
  //   image:
  //     'https://cugoldeneagles.com/images/2019/7/11/CU_Facilities_Digital_12.jpg'
  // });
  ...
  //   image:
  //     'https://news.nd.edu/assets/320255/1000x562/rolfs_athletic_hall_27_feature.jpg'
  // });
  ...
  //   image:
  //     'https://jbuathletics.com/images/2016/8/14//20140729_ms1_athletics_facilities_8743.jpg'
  // });
